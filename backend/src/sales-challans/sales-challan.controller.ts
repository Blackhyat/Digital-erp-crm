...
import {
  ...
  updateSalesChallanStatusSchema,
} from "./sales-challan.validation.js";
...
export const updateSalesChallanStatus = async (
  req: Request,
  res: Response
) => {
  try {
    ...
    const validation = updateSalesChallanStatusSchema.safeParse(
      req.body
    );
